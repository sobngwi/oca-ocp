...
public class CrDemo
    ...
    private static void zeroParameterConstructorRef(){
        ZeroParameterfactory<CrDemo> factory = CrDemo::new;
        factory.of().run();
    }
    ...
    @FunctionalInterface
    interface ZeroParameterfactory<R>{
        R of();
    }
