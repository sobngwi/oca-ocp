...
public class Ex9 {
    ...
    private void runTest(int maxIterations) throws InterruptedException {
        ...
        primeCache.entrySet().forEach((e) -> System.out.println("before " + "key :" + e.getKey() + " value :" + e.getValue()));
        ...
        primeCache.entrySet().forEach((e) -> System.out.println("after " + "key :" + e.getKey() + " value :" + e.getValue()));
    }
