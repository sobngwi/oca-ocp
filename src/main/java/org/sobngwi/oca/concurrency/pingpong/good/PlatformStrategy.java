...
public abstract class PlatformStrategy
{
    ...
    /** 
     * The singleton @a PlatformStrategy getOptionsInstance.
     */
    private static PlatformStrategy sUniqueInstance = null;

    /** 
     * Method to return the one and only singleton getOptionsInstance.
     */
     ...
     * and only singleton getOptionsInstance.
     */
