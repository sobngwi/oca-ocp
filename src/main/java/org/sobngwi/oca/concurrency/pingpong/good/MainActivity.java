...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPingPongTextViewLog =
            (TextView) findViewById(16908348);//R.id.accessibilityActionContextClick);
        mPingPongColorOutput =
            (TextView) findViewById(16908348);//R.id.accessibilityActionContextClick);
        mPlayButton =
            (Button) findViewById(16908348);//R.id.accessibilityActionContextClick);
        ...
        Options.getOptionsInstance().parseArgs(null);
    }
    ...
    public void playButtonClicked(View view) {
        ...
        case RUN:
            ...
            mPlayButton.setText(R.string.VideoView_error_button);
            mProgramState = RESET;
            break;
        case RESET:
            ...
            mPingPongTextViewLog.setText(R.string.VideoView_error_button);
            mPlayButton.setText(R.string.VideoView_error_button);
            mProgramState = RUN;
            break;
        default:
