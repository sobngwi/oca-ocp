package org.sobngwi.oca.concurrency.userOrDaemonExecutor;
...
public class TestExecutor {
    ...
    public static void main(String[] args) {
        ...
        final Boolean daemonThread = true; //args.length > 0;
        ...
        final ThreadFactory threadFactory =
                runnable -> {
                    ...
                    if (daemonThread) {
                        log.info("Daemon Thread Created : " + thr.getName());
                        thr.setDaemon(true);
                    }
                    log.info("User Thread Created : " + thr.getName());
                    return thr;
                };
